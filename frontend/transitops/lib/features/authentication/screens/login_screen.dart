...
class _LoginScreenState extends State<LoginScreen>
  ...
  Widget _quickPanel() {
    final roles = [
      _QR('Fleet Manager', Icons.admin_panel_settings_rounded,
          const Color(0xFFF59E0B), 'manager@transitops.smart'),
      _QR('Driver', Icons.person_pin_rounded,
          const Color(0xFF10B981), 'driver@transitops.smart'),
      _QR('Safety Officer', Icons.shield_rounded,
          const Color(0xFFF97316), 'safety@transitops.smart'),
      _QR('Financial Analyst', Icons.bar_chart_rounded,
          const Color(0xFFA855F7), 'finance@transitops.smart'),
    ];
