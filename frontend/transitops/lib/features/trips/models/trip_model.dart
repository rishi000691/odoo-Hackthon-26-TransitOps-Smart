...
class Trip {
  ...
  factory Trip.fromJson(Map<String, dynamic> json) {
    return Trip(
      ...
      plannedDistance: double.parse(json['planned_distance'].toString()),
      actualDistance: json['actual_distance'] != null ? double.parse(json['actual_distance'].toString()) : null,
      fuelConsumed: json['fuel_consumed'] != null ? double.parse(json['fuel_consumed'].toString()) : null,
      revenue: double.parse((json['revenue'] ?? 0.0).toString()),
