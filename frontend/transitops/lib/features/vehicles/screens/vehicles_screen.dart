...
class _VehiclesScreenState extends State<VehiclesScreen> {
          ...
          SingleChildScrollView(
            ...
            child: Row(
              children: [
                ...
                Icon(Icons.lens, size: 4, color: context.kTextSecondary),
                const SizedBox(width: 16),
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Text('Operations Logs', style: GoogleFonts.outfit(color: context.kTextPrimary, fontWeight: FontWeight.bold, fontSize: 15)),
                if (vehicle.status != VehicleStatus.retired)
                  PopupMenuButton<String>(
                    ...
                    itemBuilder: (ctx) => [
                      PopupMenuItem(value: 'fuel', child: Text('Record Fuel Log', style: TextStyle(color: ctx.kTextPrimary))),
                      PopupMenuItem(value: 'expense', child: Text('Record Expense', style: TextStyle(color: ctx.kTextPrimary))),
                    ],
                  ),
              ],
            ),
            ...
            BlocBuilder<ExpenseBloc, ExpenseState>(
              builder: (ctx, expenseState) {
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        if (expenseState.fuelLogs.isEmpty)
                          Text('No fuel logs', style: GoogleFonts.outfit(color: context.kTextSecondary, fontSize: 12))
                        else
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        if (expenseState.expenses.isEmpty)
                          Text('No other expenses', style: GoogleFonts.outfit(color: context.kTextSecondary, fontSize: 12))
                        else
                ...
                if (logWidgets.isEmpty) {
                  return Text('Click a vehicle to load its operations logs', style: GoogleFonts.outfit(color: context.kTextSecondary, fontSize: 13));
                }
  ...
  Widget _buildLogItem(IconData icon, String title, String amount, String date) {
    return Container(
      ...
      child: Row(
        children: [
          Icon(icon, color: context.kTextSecondary, size: 16),
          const SizedBox(width: 10),
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(title, style: GoogleFonts.outfit(color: context.kTextPrimary, fontSize: 13, fontWeight: FontWeight.w600)),
                Text(date, style: GoogleFonts.outfit(color: context.kTextSecondary, fontSize: 11)),
              ],
            ),
          ),
    ...
    showDialog(
      ...
      builder: (ctx) {
        return AlertDialog(
          ...
          title: Text('Register New Vehicle', style: GoogleFonts.outfit(color: context.kTextPrimary, fontWeight: FontWeight.bold)),
  ...
  void _showUpdateStatusDialog(BuildContext context, Vehicle vehicle) {
    ...
    showDialog(
      ...
      builder: (ctx) {
        return AlertDialog(
          backgroundColor: context.kSurface,
          title: Text('Update Vehicle Status', style: GoogleFonts.outfit(color: context.kTextPrimary, fontWeight: FontWeight.bold)),
  ...
  void _showRetireConfirmation(BuildContext context, Vehicle vehicle) {
    showDialog(
      ...
      builder: (ctx) {
        return AlertDialog(
          backgroundColor: context.kSurface,
          title: Text('Retire Vehicle', style: GoogleFonts.outfit(color: context.kTextPrimary, fontWeight: FontWeight.bold)),
          content: Text(
  ...
  void _showLogFuelDialog(BuildContext context, Vehicle vehicle) {
    ...
    showDialog(
      ...
      builder: (ctx) {
        return AlertDialog(
          backgroundColor: context.kSurface,
          title: Text('Record Fuel Log', style: GoogleFonts.outfit(color: context.kTextPrimary, fontWeight: FontWeight.bold)),
          content: Form(
            key: formKey,
            child: Column(
              mainAxisSize: MainAxisSize.min,
  ...
  void _showLogExpenseDialog(BuildContext context, Vehicle vehicle) {
    ...
    showDialog(
      ...
      builder: (ctx) {
        return AlertDialog(
          backgroundColor: context.kSurface,
          title: Text('Record Other Expense', style: GoogleFonts.outfit(color: context.kTextPrimary, fontWeight: FontWeight.bold)),
          content: Form(
            key: formKey,
            child: Column(
              mainAxisSize: MainAxisSize.min,
